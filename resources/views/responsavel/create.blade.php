...
<div class="my-4">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{'responsavel.index'}}">Responsaveis /</a></li>
    ...
    <form method="POST" action="{{ route('responsavel.store') }}">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <input type="text" class="form-control @error('name') is-invalid @enderror" name="nome" id="nome">
          @error('nome')
