...
<div class="row align-items-center">
    ...
    <div class="col">
        <a href="{{ route('turma.create') }}"><button class="btn btn-success float-end">Nova turma</button></a>
    </div>
    <div class="card">
        <div class="card-body">
            ...
            <table class="table table-striped table-hover" id="turmas_connections">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $turma->idioma }}</td>
                            <td>{{ $turma->livros == NULL ? ' ' : $turma->livros->nome }}</td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('turma.listadealunos', $turma->id ) }}" class="edit-icon me-1">
                                    <i class="icofont-navigation-menu"></i> Ver integrantes
                                </a>
                                ...
                                <a href="#" class="edit-icon me-1" style="color:#02b6bf;">
                                    <i class="icofont-paper"></i> Diários de aula
                                </a>
                            </td>
                        </tr>
                        @endif
    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <table class="table table-striped table-hover" id="turmas_interactive">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col">Modalidade</th>
