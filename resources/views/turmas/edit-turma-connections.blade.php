            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="00:00" name="hr_inicio" class="form-control" id="hr_inicio" value="{{$turma->hr_inicio}}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="Horário" class="mb-2 form-label"></label>
                        <input type="text" placeholder="00:00" name="hr_termino" class="form-control" id="hr_termino" value="{{$turma->hr_termino}}">
                    </div>
                </div>
            </div>
        </div>
